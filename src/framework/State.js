 ...
 * - [backbone](http://github.com/jashkenas/backbone)
 * 
...
define([
     ...
     *     @param {Array} [config.managers]
     *     @param {Object} [config.initialize]
    ...
    return Backbone.History.extend({
         ...
         *     @param {Model} [options.silent] If the app should not load the initial state from the URL
